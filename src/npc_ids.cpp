...
Boss boss_largos = Boss().setIds({ 21105, 21089 }).setTimer(2 * 4 * 60 * 1000).setName("Twin Largos");//TODO get boss HP
Boss boss_qadim = Boss().setIds({ 20934 }).setTimer(13 * 60 * 1000).setName("Qadim");//TODO get boss HP
Boss boss_adina = Boss().setIds({ 22006 }).setTimer(8 * 60 * 1000).setName("Adina");//TODO get boss HP
Boss boss_sabir = Boss().setIds({ 21964 }).setName("Sabir");//TODO get boss HP
Boss boss_qadim2 = Boss().setIds({ 22000 }).setTimer(12 * 60 * 1000).setName("Qadim the Peerless");
